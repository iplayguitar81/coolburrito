                     ...
                     <div data-role="collapsible" data-collapsed-icon="carat-d">
                         ...
                         @foreach($posts as $item)
                             ...
                             <div class="ui-grid-b">
                                 ...
                                     <div class="ui-block-c"><div class="ui-bar ui-bar-a" style="height:60px">                             <a href="{{ url('posts', $item->id) }}" class="ui-btn ui-icon-carat-r ui-btn-icon-right" data-ajax="false"><div class="ui-block-c"><input type="submit" value="Yes"></div></a></div></div>
                             </div><!-- /grid-b -->
