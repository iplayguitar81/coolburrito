...
@section('content')
    ...
    <div data-role="page" data-theme="b" id="mappins">
        ...
        <div data-role="panel"  id="myPanel" data-position="right" class="ui-body-a">
            <a href="#pageone" data-rel="close" class="ui-btn ui-btn-inline ui-shadow ui-corner-all ui-btn-a ui-icon-navigation ui-btn-icon-right ui-body-a" data-ajax="false" data-mini="true"><span class="orangose3">Back to Map</span></a>
