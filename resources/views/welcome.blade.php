                             ...
                             @endphp
                                 ...
                                 <div class="ui-grid-solo">
                                     <div class="ui-block-a">
                                         ...
                                         <li class="blog-mini-li" style=""><a href="{{ route('posts.show', [$item->id, str_slug($item->title)]) }}" class="blog-mini-li" data-ajax="false">
